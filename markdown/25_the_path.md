...
```bash
bch709@:learning_unix$ echo $USER
bch709
bch709@:learning_unix$ echo $HOME
/home/bch709
bch709@:learning_unix$ echo $PATH
/home/bch709/.nvm/versions/node/v5.1.0/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin                       
```
